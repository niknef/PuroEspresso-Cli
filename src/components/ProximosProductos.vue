        ...
        products: [
          {
            ...
            imageName: "cafetera-italiana.jpg", 
          ...
          },
          {
            ...
            imageName: "molinillo-profesional.jpg",
...
<template>
    <div class="album py-1 text-center">
      <div class="container">
        <h2 class="fw-bold text-brown mb-4">Próximos Productos</h2>
